...
innerLoop:
    ...
    mov rax, 0
pixelLoop:
    ; check if iter counter is 128
    cmp rax, 128
    je endPixelLoop

    ; calc zReal^2
    movsd xmm8, xmm6 ; xmm8 = zReal
    mulsd xmm8, xmm6 ; xmm8 = zReal^2
    
    ; calc zImag^2
    movsd xmm9, xmm7 ; xmm9 = zImag
    mulsd xmm9, xmm7 ; xmm9 = zImag^2
    ...
    addsd xmm8, xmm1 ; xmm8 = zReal^2 - zImag^2 + cReal

    ; calc new zImag
    movsd xmm9, xmm6 ; xmm9 = zReal
    mulsd xmm9, xmm7 ; xmm9 = zReal * zImag
    addsd xmm9, xmm9 ; xmm9 = 2 * zReal * zImag
    addsd xmm9, xmm2 ; xmm9 = 2 * zReal * zImag + cImag

    ; update zReal and zImag
    movsd xmm6, xmm8 ; zReal = xmm8
    movsd xmm7, xmm9 ; zImag = xmm9
